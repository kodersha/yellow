...
class YellowMeta {
    ...
    public function onParsePageExtra($page, $name) {
        ...
        if ($name=="header" && !$page->isError()) {
            ...
            $output .= "<meta name=\"description\" content=\"".$page->getHtml("description")."\" />\n";
            $output .= "<meta name=\"author\" content=\"".$page->getHtml("author")."\" />\n";
            ...
            $output .= "<meta property=\"twitter:title\" content=\"".$page->getHtml("title")."\" />\n";
            $output .= "<meta property=\"twitter:image\" content=\"".htmlspecialchars($imageUrl)."\" />\n";
            $output .= "<meta name=\"twitter:card\" content=\"summary_large_iamge\" />\n";
            $output .= "<meta name=\"twitter:site\" content=\"@kodershaSasha\" />\n";
            $output .= "<meta name=\"twitter:creator\" content=\"@kodershaSasha\" />\n";
            $output .= "<meta name=\"generator\" content=\"Datenstrom Yellow\" />\n";
